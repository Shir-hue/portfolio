    ...
    const projects = [
        {
            ...
            description: "A comprehensive e-commerce platform built with automatic AI Description using Gemini API KEY, featuring product generation, and a user friendliness.",
            image: "img/Jumpstart E-commerce2.png",
            technologies: ["React.js", "Python", "Gemini API", "Tailwind CSS"],
            categories: ["web", "mobile"],
            liveUrl: "https://jumpstart-e-commerce.vercel.app/",
            githubUrl: "https://github.com/Shir-hue/Jumpstart-E-commerce.git"
        },
        {
            title: "Meals on Wheels",
            description: "MerryMeal — a charitable delivery platform connecting volunteers with seniors and disabled adults in need, featuring comprehensive management for meals, volunteers, and community partnerships.",
            image: "img/Meals-on-wheels.png",
            technologies: ["Java", "Node.js", "MySQL", "Spring Boot", "Spring Security", "Tailwind CSS"],
            categories: ["web"],
            liveUrl: "#",
            githubUrl: "https://github.com/AlexAutumns/MerryMeals-TeamBanana.git"
        },
        {
            title: "Judo Martial Arts Athletes Fee Calculator",
            description: "A Personalized fee calculation system for North Sussex Judo, streamlining monthly training fee calculations for athletes of all ages and experience levels using AQDS development standards.",
            image: "https://images.unsplash.com/photo-1555597673-b21d5c935865?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            technologies: ["Java"],
            categories: ["backend"],
            liveUrl: "#",
            githubUrl: "https://github.com/Shir-hue/Judo-fee-calculator.git"
        },
    ];
